          ...
          <div className="container pt-5">
            <div className="row">
              <div className="col-lg-8 mb-5">
                ...
                <p>
                  Thời gian tạm thời là elitr tại rebum tại clita aliquyam
                  consetetur. Diam dolor diam ipsum et, thời gian voluptua sit
                  consetetur sit. Aliquyam diam amet diam et eos sadipscing
                  labore. Clita erat ipsum et lorem et sit, sed stet no labore
                  lorem sit. Sanctus clita duo justo et tempor consetetur
                  takimata eirmod, dolores takimata consetetur invidunt magna
            ...
            >
              <div className="rent-item">
                <img
                  ...
                  src={`${process.env.PUBLIC_URL}/assets/img/car-rent-1.png`}
                  alt=""
                />
              ...
              <div className="rent-item">
                <img
                  className="img-fluid mb-4"
                  src={`${process.env.PUBLIC_URL}/assets/img/car-rent-2.png`}
                  alt=""
                />
                <h4 className="text-uppercase mb-4">Mercedes Benz R3</h4>
                <div className="d-flex justify-content-center mb-4">
              ...
              <div className="rent-item">
                <img
                  className="img-fluid mb-4"
                  src={`${process.env.PUBLIC_URL}/assets/img/car-rent-3.png`}
                  alt=""
                />
                <h4 className="text-uppercase mb-4">Mercedes Benz R3</h4>
                <div className="d-flex justify-content-center mb-4">
              ...
              <div className="rent-item">
                <img
                  className="img-fluid mb-4"
                  src={`${process.env.PUBLIC_URL}/assets/img/car-rent-4.png`}
                  alt=""
                />
                <h4 className="text-uppercase mb-4">Mercedes Benz R3</h4>
                <div className="d-flex justify-content-center mb-4">
